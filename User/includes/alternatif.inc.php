...
class Alternatif {
	...
	function readAll() {
		...
		function readAllindex() {
		$query = "SELECT * FROM {$this->table_name} ORDER BY hasil_akhir DESC LIMIT 4";
		$stmt = $this->conn->prepare( $query );
		$stmt->execute();
		...
		return $stmt;
			...
			function readAllmb() {
		$query = "SELECT * FROM {$this->table_name} ORDER BY id_alternatif ASC LIMIT 5";
		$stmt = $this->conn->prepare( $query );
		$stmt->execute();
		...
		function readAllsc() {
		$query = "SELECT * FROM {$this->table_name} ORDER BY id_alternatif ASC LIMIT 5 OFFSET 5";
		$stmt = $this->conn->prepare( $query );
		$stmt->execute();
		...
		function readAllnc() {
		$query = "SELECT * FROM {$this->table_name} ORDER BY id_alternatif ASC LIMIT 5 OFFSET 10";
		$stmt = $this->conn->prepare( $query );
		$stmt->execute();
		...
		return $stmt;
				...
				function readAllteh() {
		$query = "SELECT * FROM {$this->table_name} ORDER BY id_alternatif ASC LIMIT 5 OFFSET 15";
		$stmt = $this->conn->prepare( $query );
		$stmt->execute();
		...
		$query = "SELECT nama, Harga FROM {$this->table_name} ORDER BY id_alternatif DESC LIMIT 5";
		$stmt = $this->conn->prepare( $query );
		$stmt->execute();
	...
	function readAllmt() {
		$query = "SELECT * FROM {$this->table_name} a JOIN nilai_awal b ON a.id_alternatif=b.id_alternatif WHERE b.nilai>=60 ORDER BY hasil_akhir DESC";
		$stmt = $this->conn->prepare( $query );
		$stmt->execute();
		...
		$query = "SELECT * FROM {$this->table_name} a JOIN nilai_awal b ON a.id_alternatif=b.id_alternatif WHERE b.nilai>=60";
		$stmt = $this->conn->prepare( $query );
		$stmt->execute();
