...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2021 at 03:40 PM
...
('KOS', 'KOS', 'Kopi Oreo Susu', 20000, 0.270815912871746),
('KSC', 'KSC', 'Kopi Susu Coklat', 22000, 0.193893386033071),
('KSO', 'KSO', 'Kopi Susu Original', 18000, 0.240715556801729),
('KSS', 'KSS', 'Kopi Susu Segmen', 18000, 0.294575144293445);
...
('C1', 'Rasa.', 2.08333333333333, 0.46581939799330996),
...
('KOS', 'C2', 4.5, 0.22222222222222, 0.061586770717205),
('KOS', 'C3', 4, 0.25, 0.040267558528428),
('KOS', 'C4', 3.25, 0.3076923076923075, 0.029529199897093),
('KSC', 'C1', 4.9925373134328, 0.2002991774298925, 0.093303242248948),
('KSC', 'C2', 9, 0.11111111111111, 0.030793385358602),
('KSC', 'C3', 4, 0.25, 0.040267558528428),
('KSC', 'C4', 3.25, 0.3076923076923075, 0.029529199897093),
('KSO', 'C1', 4.9925373134328, 0.2002991774298925, 0.093303242248948),
('KSO', 'C2', 3, 0.33333333333333, 0.092380156075807),
('KSO', 'C3', 4, 0.25, 0.040267558528428),
('KSO', 'C4', 6.5, 0.1538461538461525, 0.014764599948546),
('KSS', 'C1', 3.33333333333334, 0.3000745146478375, 0.13978052976639),
('KSS', 'C2', 3, 0.33333333333333, 0.092380156075807),
('KSS', 'C3', 4, 0.25, 0.040267558528428),
('KSS', 'C4', 4.33333333333327, 0.23076923076923, 0.02214689992282);
...
(1, 'aldi', 'atasan', 'aldiatasan', 'aldiatasan'),
(2, 'aldi', 'kepegawaian', 'adaw', 'adaw');
...
--
ALTER TABLE `nilai_awal`
  MODIFY `id_nilai_awal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `nilai_awal_detail`
--
ALTER TABLE `nilai_awal_detail`
  MODIFY `id_nilai_awal_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
