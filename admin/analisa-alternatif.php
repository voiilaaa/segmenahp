...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12">
		<ol class="breadcrumb">
			...
			<li><a href="modal-nilai.php" data-toggle="modal" data-target="#myModalalt">Tabel Analisa Alternatif</a></li>
		</ol>
								...
								<div class="row">
									...
									<div class="col-xs-12 col-md-6">
										<div class="form-group">
											...
											<?php $stmt1 = $nilObj->readAllkriteria(); while ($row2 = $stmt1->fetch(PDO::FETCH_ASSOC)): ?>
