                            ...
                            <div class=" form">    
                                ...
                                <form class="cmxform form-horizontal " id="commentForm" method="POST" action="update_contact.php">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input name="subject" class=" form-control" type="text" value="<?php echo $row['subject'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label  class="control-label col-lg-3">Pesan</label>
                                        <div class="col-lg-6">
                                           <textarea name="pesan" class=" form-control"  type="text" value="<?php echo $row['pesan'];?>"></textarea> 
                                        </div>
                                    </div>                                                                
