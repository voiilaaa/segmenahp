...
<?php 
    ...
    if($_SESSION['status']!="login"){
        header("location:../menu_table.php?pesan=belum_login");
    }
    ?>
...
?>
          <tr data-expanded="true">
            ...
            <td><a href="edit_reservation.php?id=<?php echo $row['id'];?>">Edit</a></td>
           <td><a href="delete_reservation.php?id=<?php echo $row['id'];?>">Hapus</a></td>
          </tr>
          <?php }
            $kon->close();?> 
        </tbody>
