                       ...
                       Edit Booking
                        ...
                        <div class="panel-body">
                            <div class=" form">    
                                ...
                                <form class="cmxform form-horizontal " id="commentForm" method="POST" action="update_reservation.php">
                                    ...
                                    <div class="form-group ">
                                        <label  class="control-label col-lg-3">Nama Depan</label>
                                        <div class="col-lg-6">
                                            <input name="fname" class=" form-control" type="text" value="<?php echo $row['fname'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label  class="control-label col-lg-3">Nama Belakang </label>
                                        <div class="col-lg-6">
                                            <input name="lname" class=" form-control" type="text" value="<?php echo $row['lname'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label  class="control-label col-lg-3">Tanggal</label>
                                        <div class="col-lg-6">
                                            <input name="tanggal" class=" form-control" type="date" value="<?php echo $row['tanggal'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label  class="control-label col-lg-3">Waktu</label>
                                        <div class="col-lg-6">
                                            <input name="waktu" class=" form-control"  type="text" value="<?php echo $row['waktu'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label  class="control-label col-lg-3">Telepon</label>
                                        <div class="col-lg-6">
                                            <input name="telepon" class=" form-control" type="text" value="<?php echo $row['telepon'];?>">
                                        </div>
                                    </div>  
                                    <div class="form-group ">
                                        <label  class="control-label col-lg-3">Keterangan</label>
                                        <div class="col-lg-6">
                                            <input name="keterangan" class=" form-control" type="text" value="<?php echo $row['keterangan'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label  class="control-label col-lg-3">Status</label>
                                        <div class="col-lg-6">
                                            <input name="status" class=" form-control" type="text" value="<?php echo $row['status'];?>">
                                        </div>
                                    </div>                                                                 
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <button class="btn btn-primary" name="updatereservation" type="submit">Save</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
