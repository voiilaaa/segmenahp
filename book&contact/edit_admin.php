                       ...
                       Edit Booking
                        ...
                        <div class="panel-body">
                            <div class=" form">    
                                ...
                                <form class="cmxform form-horizontal " id="commentForm" method="POST" action="update_admin.php">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <button class="btn btn-primary" name="updateadmin" type="submit">Save</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
